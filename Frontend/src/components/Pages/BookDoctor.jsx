...
// import { DayPicker } from "react-day-picker"; // 🔥 Switched to react-day-picker
...
//   const [loading, setLoading] = useState(false);
//   const [submitted, setSubmitted] = useState(false);
//   const [dateOpen, setDateOpen] = useState(false); // 🔥 Popover State
...
//                         </button>
//                       </PopoverTrigger>
//                       <PopoverContent className="rm-popover" align="start" sideOffset={8}>
//                         <DayPicker
//                           mode="single"
//                           selected={form.date}
...
//               ) : (
//                 <button onClick={handleSubmit} disabled={loading} style={{...styles.primaryBtn, flex: 1, opacity: loading ? 0.7 : 1}}>
//                   {loading ? <Loader2 size={20} className="animate-spin mx-auto" /> : "Confirm Appointment"}
//                 </button>
//               )}
//             </div>
